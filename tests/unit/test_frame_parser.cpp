...
TEST_F(FrameParserTest, ValidIpv4Frame) {
    uint8_t data[] = {0x88, 0x86, 0x03, 0xFA, 0x52, 0x91, 0xA4, 0x97, 0xB1,
                      0x70, 0x18, 0xD7, 0x08, 0x00, 0x45, 0x00, 0x00, 0x34};
...
TEST_F(FrameParserTest, ValidArpFrame) {
    uint8_t data[] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xAA, 0xBB, 0xCC,
...
TEST_F(FrameParserTest, UnicastDestination) {
    uint8_t data[] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55,  // unicast (LSB=0)
...
TEST_F(FrameParserTest, MulticastDestination) {
    uint8_t data[] = {0x01, 0x00, 0x5E, 0x00, 0x00, 0x01,  // multicast (LSB=1)
...
TEST_F(FrameParserTest, BroadcastDestination) {
    uint8_t data[] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00,
...
TEST_F(FrameParserTest, LocallyAdministeredMac) {
    uint8_t data[] = {0x02, 0x00, 0x00, 0x00, 0x00, 0x01,  // locally administered
                      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
TEST_F(FrameParserTest, Ipv6EtherType) {
    uint8_t data[] = {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x86, 0xDD  // IPv6
    };
...
TEST_F(FrameParserTest, VlanTag) {
    uint8_t data[] = {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x81, 0x00,  // VLAN
        0x00, 0x64  // VLAN ID
    };
...
TEST_F(FrameParserTest, PayloadPointerValidity) {
    uint8_t data[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                      0x00, 0x00, 0x00, 0x00, 0x00, 0xDE, 0xAD, 0xBE, 0xEF};
...
TEST_F(FrameParserTest, TcpSynPacket) {
    uint8_t data[] = {
        0x52, 0x54, 0x00, 0x12, 0x34, 0x56, 0x08, 0x00, 0x27, 0xAB, 0xCD, 0xEF, 0x08, 0x00,  // IPv4
...
TEST_F(FrameParserTest, DnsQueryPacket) {
    uint8_t data[] = {0x00, 0x0C, 0x29, 0x12, 0x34, 0x56, 0x00, 0x50,
                      0x56, 0xAB, 0xCD, 0xEF, 0x08, 0x00, 0x45, 0x00};
